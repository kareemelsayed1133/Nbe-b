...
export const categoriesMap = {
  "الخزينة": ["سحب نقدي", "إيداع", "صرف شيك", "تحويل"],
  "خدمة العملاء": ["فتح حساب", "تحديث بيانات", "إصدار بطاقة", "شهادات / ودائع", "قروض"],
  "الاستقبال": ["استعلامات", "شكاوى"],
  "أيباج": ["تحويلات ويسترن يونيون"]
};
